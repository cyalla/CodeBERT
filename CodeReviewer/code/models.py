...
MODEL_CLASSES = {
    "qwen2.5": (AutoConfig, ReviewerModelQwen, AutoTokenizer),  # Custom logic for Qwen
...
def build_or_load_gen_model(args):
    assert args.model_type.lower() in ["qwen2.5","codet5", "t5", "scratch"]  # only t5 supported now
